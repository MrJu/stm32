...
/* A0 -> GND: addr -> 0x68; A0 -> VCC: addr -> 0x69 */
#define MPU6050_SLAVE_ADDRESS  (0x68 << 1)

#define MPU6050_WHO_AM_I        0x75
#define MPU6050_SMPLRT_DIV      0  /* 8000Hz */
#define MPU6050_DLPF_CFG        0
#define MPU6050_GYRO_OUT        0x43     /* MPU6050 GYRO data reg addr */
#define MPU6050_ACC_OUT         0x3B     /* MPU6050 ACC data reg addr */
...
void PMU6050_Read_Data(uint8_t reg_addr, uint8_t *Read, uint8_t num);
void PMU6050_Write_Reg(uint8_t reg_addr, uint8_t reg_data);
